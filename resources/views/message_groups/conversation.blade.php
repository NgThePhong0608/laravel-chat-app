...
@section('content')
    <div class="row chat-row">
        ...
        <div class="col-md-3">
            ...
            @if (isset($currentGroup->message_group_member) && !empty($currentGroup->message_group_member))
                <ul class="list-group">
                    @foreach ($currentGroup->message_group_member as $member)
                ...
                <form action="{{ route('message-groups.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select id="selectMember" class="form-control" name="user_id[]" id=""
                                multiple="multiple">
                                @foreach ($users as $user)
    ...
    <script>
        $(function() {
            ...
            function sendMessage(message) {
                let url = "{{ route('messages.send-group') }}";
                let form = $(this);
